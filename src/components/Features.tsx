...
export function Features() {
  ...
  return (
    <section className="relative bg-black pt-12 sm:pt-20 pb-12 sm:pb-20 overflow-hidden">
      {/* Gradient Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-900/10 via-black to-blue-900/10" />
      
      {/* Glowing Orbs */}
      <div className="absolute bottom-0 left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-purple-500/20 rounded-full blur-3xl opacity-60" />
      <div className="absolute -top-32 right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-blue-500/20 rounded-full blur-3xl opacity-60" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative bg-gray-900/80 backdrop-blur-sm p-5 sm:p-6 rounded-2xl border border-gray-800 h-full">
