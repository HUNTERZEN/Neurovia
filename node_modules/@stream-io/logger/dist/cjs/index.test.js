...
(0, node_test_1.describe)("logger", () => {
    (0, node_test_1.beforeEach)(() => {
        (0, index_ts_1.restoreDefaults)();
    });
    (0, node_test_1.it)("exposes log level per scope", () => {
        const { sink } = capture();
        (0, index_ts_1.configureLoggers)({
            default: { level: "info", sink },
            "coordinator": { level: "debug", sink },
            "network": { level: "error", sink },
        });
        const coordinatorLogger = (0, index_ts_1.getLogger)("coordinator");
        const networkLogger = (0, index_ts_1.getLogger)("network");
        const apiCallsLogger = (0, index_ts_1.getLogger)("api-calls");
    ...
    (0, node_test_1.it)("checks if the message in in correct format", () => {
        ...
        (0, index_ts_1.getLogger)("api-calls", { tags: ["v1", "v2"] }).info("Calling api");
    ...
    (0, node_test_1.it)("filters below default level (info)", () => {
        ...
        (0, index_ts_1.getLogger)("scope").info("should not be logged");
        (0, index_ts_1.getLogger)("scope").error("should be logged");
        (0, index_ts_1.getLogger)("api-call").info("calling api");
        (0, index_ts_1.getLogger)("coordinator", { tags: ["v2"] }).info("coordinator test");
        (0, index_ts_1.getLogger)("network").warn("network call");
