...
import { Calendar, Clock, Monitor, Video, Mic, MessageSquare } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-gray-800 rounded-xl p-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((expert) => (
            <div key={expert} className="bg-gray-900 rounded-lg p-4">
              <div className="flex items-center mb-4">
                <img
                ...
                <div className="ml-3">
                  ...
                  <div className="flex items-center text-yellow-400">
                    {"★".repeat(5)} <span className="text-gray-400 ml-1">(120 reviews)</span>
                  </div>
                </div>
              </div>
              ...
              <button className="w-full bg-primary hover:bg-primary-dark py-2 rounded-lg transition-colors">
                Schedule Session
              </button>
            </div>
          ))}
