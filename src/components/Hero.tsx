...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen pt-16 sm:pt-20 pb-4 overflow-hidden flex flex-col" style={{ minHeight: '100dvh' }}>
      <div className="relative flex-1">
        ...
        {/* Animated Orbs */}
        <motion.div
          className="absolute left-1/4 top-1/4 w-48 h-48 sm:w-64 sm:h-64 rounded-full bg-purple-500/30 blur-3xl"
          style={{ x: leftOrbX, opacity: orbOpacity }}
        />
        <motion.div
          className="absolute right-1/4 top-1/3 w-48 h-48 sm:w-64 sm:h-64 rounded-full bg-blue-500/30 blur-3xl"
          style={{ x: rightOrbX, opacity: orbOpacity }}
        />

        <div className="relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="pt-6 pb-12 sm:pt-12 sm:pb-16 lg:pt-20 lg:pb-24">
              {/* Content Grid */}
              <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
                ...
                >
                  <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
                    <span className="block bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent mb-1 sm:mb-2">
                      Expert Tech Support
                    </span>
                  ...
                  <p className="mt-4 sm:mt-6 text-sm sm:text-lg text-gray-400 max-w-2xl mx-auto lg:mx-0 px-2 sm:px-0">
                  ...
                  <motion.div
                    className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start mt-8 sm:mt-10 px-4 sm:px-0"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: 0.8 }}
                  >
                    <Link to="/remote-help" className="relative group w-full sm:w-auto">
                      ...
                      <button className="relative w-full px-6 py-3 bg-black rounded-lg text-white font-semibold flex items-center justify-center gap-2">
                        Get Remote Help
                  ...
                  {/* Stats */}
                  <motion.div
                    className="mt-10 sm:mt-12 flex flex-row items-center gap-6 sm:gap-8 justify-center lg:justify-start"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <div className="text-center sm:text-left">
                      ...
                      <p className="text-xs sm:text-sm text-gray-400">verified experts</p>
                    </div>
                    <div className="w-px h-8 sm:h-12 bg-gray-800" />
                    <div className="text-center sm:text-left">
                ...
                <motion.div
                  className="relative lg:ml-auto px-2 sm:px-0"
                  style={{ y: rightContentY }}
                >
                  <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-800 shadow-2xl">
